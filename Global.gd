...
#Const for messages 
const RAJA_MESSAGE := "CONGRAT, YOU WERE THE RAJA AND GOT 1000 POINTS"
const SIPAHI_MESSAGE := "YOU HAD A EASY ROUND AS THE SIPAHI AND GOT 700 POINTS"
const WAZIR_WIN_MASSAGE := "YOU FOUND THE THEAF AND GOT 800 POINTS"
const WAZIR_LOSS_MESSAGE := "YOU WERE WRONG ... SO NO POINTS FOR YOU"
const CHOR_LOSS_MESSAGE := "YOU GOT CAUTGH SO NOTHING FOR YOU HERE"
